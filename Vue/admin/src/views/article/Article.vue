  ...
  <el-card class="main-card">
    ...
    <div class="article-title-container">
      ...
      <el-button
        ...
        v-if="article.articleId == null || article.status == 3"
      >
        保存草稿
      </el-button>
      <el-button
      ...
      <el-form label-width="80px" size="medium" :model="article">
        ...
        <el-form-item label="上传封面">
          <el-upload
            class="upload-cover"
            drag
            action="/api/file/article/images"
            multiple
  ...
  methods: {
    ...
    uploadImg(pos, file) {
      ...
      if (file.size / 1024 < this.config.UPLOAD_SIZE) {
        ...
        this.axios
          .post("/api/file/article/images", formdata)
          .then(({ data }) => {
    ...
    autoSaveArticle() {
      ...
      // 保存本地文章记录
      if (this.autoSave && this.article.articleId == null) {
