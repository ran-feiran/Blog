  ...
  export default {
    ...
    methods:{
      async getHomeInfo() {
        ...
        const cons = res.data;
        if (cons.flag) {
          this.userCount = cons.data.data.userCount
          this.messageCount = cons.data.data.messageCount
          this.viewsCount = cons.data.data.viewsCount
          this.articleCount = cons.data.data.articleCount
        }
